...
You may also have guessed that \texttt{result.push} appends a value to the end of an array;
if you didn't,
well,
now you know.
...
\begin{enumerate}
\item
  What does \texttt{table.push} do?
\item
  How does a \texttt{while} loop work?
\item
  What does \texttt{+=} do?
\item
  What does \texttt{table.reverse} do, and what does it return?
\end{enumerate}
